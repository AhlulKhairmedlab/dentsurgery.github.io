...
<div class="body content">
    <div class="welcome">
       <br/><br/><br/><br/><br/>
        ...
        while($row = $result->fetch_assoc()){ //returns associative array of fetched row
            ...
            echo "<td>$row[phone]<td>$row[username]<td>$row[password]</div><td><a href='adminview.php?idd=$row[id]'>Delete</a>";"</td></tr></table>";
    ...
    <button type="submit" class="btn btn-primary"><a href="adticketview.php">User Tickets</a></button>
</div>
